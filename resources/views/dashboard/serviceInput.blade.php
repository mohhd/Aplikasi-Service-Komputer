                ...
                <div class="box-body">
                    <div class="row justify-content-evenly">
                        <div class="col-4">
                            ...
                            <form role="form" method="POST" action="{{ url('/inputData') }}">
                            @csrf
                            <div class="box-body">
                                ...
                                <label>Alamat</label>
                                <textarea name="alamat" cols="20" rows="3" class="form-control" placeholder="Masukkan Alamat">{{ old('alamat') }}</textarea>
                        ...
                        <div class="box-body">
                                ...
                                <div class="form-group {{$errors->has('tipe') ? 'has-error' : ''}}">
                                    <label>Tipe</label>
                                    <textarea name="tipe" cols="20" rows="4" class="form-control" placeholder="Masukkan Tipe">{{ old('tipe') }}</textarea>
                                    @if($errors->has('tipe'))
                                ...
                                <div class="form-group {{$errors->has('serial_number') ? 'has-error' : ''}}">
                                    ...
                                    <input type="text" name="serial_number" class="form-control" placeholder="Masukkan Serial Number" value="{{ old('serial_number') }}">
                        ...
                        <div class="col-4">
                            ...
                            <h2 class="h4 mb-0 text-gray-800"></h2><br><br>
                                <div class="form-group {{$errors->has('kerusakan') ? 'has-error' : ''}}">
                                    ...
                                    <textarea name="kerusakan" cols="20" rows="4" class="form-control" placeholder="Masukkan Kerusakan">{{ old('kerusakan') }}</textarea>
                                ...
                                <div class="form-group {{$errors->has('kelengkapan') ? 'has-error' : ''}}">
                                    ...
                                    <textarea name="kelengkapan" cols="20" rows="4" class="form-control" placeholder="Masukkan Kelengkapan">{{ old('kelengkapan') }}</textarea>
                                ...
                                <div class="form-group {{$errors->has('keterangan') ? 'has-error' : ''}}">
                                    ...
                                    <textarea name="keterangan" cols="20" rows="4" class="form-control" placeholder="Masukkan keterangan">{{ old('keterangan') }}</textarea>
